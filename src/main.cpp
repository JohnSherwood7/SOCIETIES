...
void runSimulation()
{
    ...
    for (int i = glob.START_DAY; i < glob.NUM_DAYS; i++) {
        ...
        /**
         * When all resources are exhausted, 
         * agents stop gathering resources, inventing, making and trading devices.
         */
        if (allExhausted == false) {
        ...
        /*
         * Still going through resources phase.
         * If MIN_RES_AMOUNT is 0, just renew 0.
         */

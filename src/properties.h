...
public:
    ...
    /**
     * Keeps track of the resources extracted from the environment on the current day.
     * Different from unitsGatheredToday. This only records the gathered resources done by work.
     */
    int unitsExtractedToday;
